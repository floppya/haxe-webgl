...
extern interface WebGLRenderingContext 
{
	...
	public function uniform1fv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform1iv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform2fv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform2iv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform3fv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform3iv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform4fv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniform4iv(location:WebGLUniformLocation, value:TypedArray):Void;
	public function uniformMatrix2fv(location:WebGLUniformLocation, transpose:GLboolean, value:TypedArray):Void;
	public function uniformMatrix3fv(location:WebGLUniformLocation, transpose:GLboolean, value:TypedArray):Void;
	public function uniformMatrix4fv(location:WebGLUniformLocation, transpose:GLboolean, value:TypedArray):Void;
	...
	public function vertexAttrib1fv(index:GLuint, value:TypedArray):Void;
	public function vertexAttrib2fv(index:GLuint, value:TypedArray):Void;
	public function vertexAttrib3fv(index:GLuint, value:TypedArray):Void;
	public function vertexAttrib4fv(index:GLuint, value:TypedArray):Void;
